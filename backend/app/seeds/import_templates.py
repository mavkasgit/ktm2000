...
IMPORT_TEMPLATES = [
    {
        ...
        "column_mapping": {
            ...
            "raw_stock_ktm": {"column": "D", "header": "Биржа КТМ на складе"},
            "color": {"column": "E", "header": "Цвет"},
            "input_quantity": {"column": "F", "header": "Кол-во доп. в 2,7"},
            "input_length": {"column": "G", "header": "Длина, м"},
            "operation": {"column": "H", "header": "Операция/Техпроцесс"},
            "packaging": {"column": "I", "header": "Упаковка"},
            "note": {"column": "J", "header": "Примечание"},
            "output_length": {"column": "K", "header": "Длина после резки, м"},
            "output_quantity": {"column": "L", "header": "Кол-во после резки готовых изделий"},
            "west_quantity": {"column": "M", "header": "Запад"},
            "east_quantity": {"column": "N", "header": "Восток"},
            "output_kind": {"column": "O", "header": "Вид готовой продукции"},
            "comments": {"column": "P", "header": "Комментарий"},
