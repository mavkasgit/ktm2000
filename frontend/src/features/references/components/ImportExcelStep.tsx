  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Импортируйте справочник из Excel. Скачайте шаблон, заполните его по
        образцу ниже и загрузите файл — откроется предпросмотр изменений.
        Состав ГП: колонки «Компонент (SKU)» и «Количество» — артикулы сырья
        и их количества через «;» (1–2 компонента); строка с составом
        создаёт ГП, без состава — сырьё.
      </p>
